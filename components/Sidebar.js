    ...
    return (
        <div className='w-64 h-full'>
            <div class=" flex flex-col top-0 left-0 w-full bg-white h-full border-r">
                ...
                <div class="flex-grow bg-neutral-800 h-full">
                    <ul class="flex flex-col py-4 space-y-1 h-screen">
                        <li class="px-5">
              ...
              >
                ...
                ></path>
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate font-sans text-neutral-300 font-bold font-style: italic">
                                    ประเภทสินค้า
                                </span>
                            </a>
                        </li>
              ...
              >
                ...
                ></path>
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate font-sans text-neutral-300 font-bold font-style: italic">สินค้า</span>
                            </a>
                        </li>
                        <li>
                            <a
              ...
              >
                ...
                ></path>
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate font-sans text-neutral-300 font-bold font-style: italic">โปรโมชั่น</span>
                            </a>
                        </li>
              ...
              >
                ...
                ></path>
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate font-sans text-neutral-300 font-bold font-style: italic">โฆษณาสินค้า</span>
                            </a>
                        </li>
                        <li class="px-5">
                            <div class="flex flex-row items-center h-8">
